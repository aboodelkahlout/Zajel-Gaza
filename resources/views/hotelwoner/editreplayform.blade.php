    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-4">
                ...
                <form method="POST" action="{{route('hotelowner.edit.reply',$reply->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="reply_text" class="form-label">نص الرد</label>
                        <textarea name="reply_text" id="reply_text" rows="4" class="form-control" required>{{$reply->reply_text}}</textarea>
                    </div>
